 ...
 */
@Controller
@RequestMapping(value = "api/rest/graphicsmagick/*")
public class GraphicsMagickResource extends BaseRestResource implements InterfaceRessource {

    /**
     * Logger.
     */
    private static final Logger LOG = LoggerFactory.getLogger(GraphicsMagickResource.class);

    @Inject
    private BildService graphicsMagickBildService;
    ...
    public void scaleImage(final HttpServletResponse response, @PathVariable("file_path") final String filePath,
        ...
        try {
            graphicsMagickBildService.scaleFile(SLASH + filePath + SLASH + filePath2 + SLASH + file + POINT + fileEnd,
