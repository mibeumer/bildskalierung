 ...
 */
@Controller
@RequestMapping(value = "api/rest/imagemagick/*")
public class ImageMagickResource extends BaseRestResource implements InterfaceRessource {

    /**
     * Logger.
     */
    private static final Logger LOG = LoggerFactory.getLogger(ImageMagickResource.class);

    private static final String SLASH = "/";
    private static final String POINT = ".";
    public static final int NO_INPUT_WIDTH_OR_HEIGHT = -1;

    @Inject
    private BildService imageMagickBildService;
    ...
    public void scaleImage(final HttpServletResponse response, @PathVariable("file_path") final String filePath,
        ...
        try {
            imageMagickBildService.scaleFile(SLASH + filePath + SLASH + filePath2 + SLASH + file + POINT + fileEnd,
